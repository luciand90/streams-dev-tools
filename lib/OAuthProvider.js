...
OAuthProvider.prototype.getAccessToken = function(credentials, callback) {
    callback(new Error('Not implemented.'));
};

OAuthProvider.prototype.storeAccessToken = function(credentails, accessToken, callback) {
    callback(new Error('Not implemented.'));
};
...
OAuthProvider.create = function (storageProvider, authConfig) {
    ...
    if (authConfig.version == '2.0') {
        return new (require('./OAuthProviders/OAuth2Provider.js'))(storageProvider, authConfig);
    } else {
        return new (require('./OAuthProviders/OAuth1Provider.js'))(storageProvider, authConfig);
    }
};
